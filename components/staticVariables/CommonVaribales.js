...
export const  StaticDataCards = [
    { id: 1, name: "Humidity", icon: require('../../assets/experienceIcons/humidite.png'), color:"#C2FEFE" },
    { id: 2, name: "Temperature", icon: require('../../assets/experienceIcons/temperature.png'), color:"#FD9093" },
    { id: 3, name: "Contact", icon: require('../../assets/experienceIcons/contact.png'), color:"#C3FFDD" },
    { id: 4, name: "Gas", icon: require('../../assets/experienceIcons/gaz.png'), color:"#E4C2F6" },
    { id: 5, name: "Orientation", icon: require('../../assets/experienceIcons/orientation.png'), color:"#C2CAFC" },
    { id: 6, name: "Force", icon: require('../../assets/experienceIcons/force.png'), color:"#CFF380" },
    { id: 7, name: "Brightness", icon: require('../../assets/experienceIcons/luminosite.png'), color:"#C2FEFE" },
    { id: 8, name: "Elevation", icon: require('../../assets/experienceIcons/elevation.png'), color:"#82B4DD" },
    { id: 9, name: "Color", icon: require('../../assets/experienceIcons/color.png'), color:"#8CE7D4" },
    { id: 10, name: "Position", icon: require('../../assets/experienceIcons/position.png'), color:"#C2CAFC" },
    { id: 11, name: "Proximity", icon: require('../../assets/experienceIcons/proximite.png'), color:"#C2FEFE" },
    { id: 12, name: "Sound", icon: require('../../assets/experienceIcons/son.png'), color:"#E9CF36" },
    { id: 13, name: "Vibration", icon: require('../../assets/experienceIcons/vibration.png'), color:"#82B4DD" },
    { id: 14, name: "Speed", icon: require('../../assets/experienceIcons/vitesse.png'), color:"#8CE7D4" },
];
